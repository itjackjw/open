                ...
                <ul class="ul2" style="height: 190px;">
                    ...
                    <li style="width: 100%;padding-left: 20px;">
                        ...
                        <span class="grText">
                            ...
                            <input type="hidden" id="sz_price"  name="sz_price" value="{$data.z_price-$reduce_price-$coupon_price}" >
        ...
        <div style="border-radius: 10px;margin-bottom: 20px;background-color: #fff;padding:10px;">
            ...
            <div class="numss">
                ...
                <span>合计支付： ￥
                    ...
                    {else} -->
                    <input type="text" id="s_z_price"  name="s_z_price" value="{$data.z_price}" {if $data.gstatus !=0} disabled {/if}/>
                    <!-- {/if} -->
                    
                    元</span>
                    <input type="hidden" id="sz_price"  name="sz_price" value="{$data.z_price}" >
            </div>
