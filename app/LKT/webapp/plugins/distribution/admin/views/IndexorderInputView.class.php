...
/*
 * @Author: your name
 * @Date: 2019-12-20 17:20:34
 * @LastEditTime : 2019-12-23 10:36:00
 * @LastEditors  : Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \LaiKeApp\app\LKT\webapp\modules\distribution\views\IndexorderInputView.class.php
 */
 ...
 */
class IndexorderInputView extends SmartyView
{
    public function execute()
    {
        ...
        if ($pageto != '') {
            ...
            $this->setTemplate('Indexorder.tpl');
        }
    }
}
